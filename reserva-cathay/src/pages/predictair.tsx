...
const Home: NextPage = () => {
  ...
  const handleCalculateTickets = () => {
    ...
    window.open(
      "https://predictair-6zecwapboym66l2kxrh2o6.streamlit.app/",
      "_blank"
    );
  };
  return (
    <AdminLayout>
            ...
            <Card.Body className="pb-0 d-flex justify-content-between align-items-start">
              <div>
                ...
                <div style={{ fontSize: "13px" }}>
                  Increase in searches for "HK to NYC" in the past week.
                </div>
              </div>
              <Dropdown align="end">
                <Dropdown.Toggle
          ...
          >
            <Card.Body className="pb-0 d-flex justify-content-between align-items-start">
              <div>
                ...
                <div style={{ fontSize: "13px" }}>
                  Increase in NYC AirBnB and Hotel bookings from Hong Kong
                </div>
              </div>
              <Dropdown align="end">
                <Dropdown.Toggle
          ...
          >
            <Card.Body className="pb-0 d-flex justify-content-between align-items-start">
              <div>
                ...
                <div style={{ fontSize: "13px" }}>
                  Increase in popularity of #NYC #NewYork #TimeSquare in Hong
                  Kong
                </div>
              </div>
              <Dropdown align="end">
      ...
      <div className="row">
        <div>
          ...
          <p style={{ marginTop: "-8px", fontSize: "15px" }}>
            Current Training Dataset used for generating tickets.
          </p>
        </div>
        <Table
          columns={[
      ...
      <div className="row">
        <div>
          ...
          <p style={{ marginTop: "-8px", fontSize: "15px" }}>
            Analyze results for recent model run for: Flight CX118
          </p>
        </div>
      ...
      <div className="row">
        <div>
          ...
          <p style={{ marginTop: "-8px", fontSize: "15px" }}>
            Manually calculate ticket number for a flight for testing.
          </p>
        </div>
        <div>
          <button
            type="button"
            style={buttonStyle}
            onClick={handleCalculateTickets}
          >
            Calculate Tickets
          </button>
        </div>
