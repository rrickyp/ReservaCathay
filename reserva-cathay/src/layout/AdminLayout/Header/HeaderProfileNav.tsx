...
export default function HeaderProfileNav() {
  ...
  return (
    <Nav>
      <Dropdown as={NavItem}>
        <Dropdown.Toggle variant="link" bsPrefix="hide-caret" className="py-0 px-2 rounded-0 text-decoration-none" id="dropdown-profile">
        <div style={{
            display: 'flex', alignItems: 'center', gap: '0.5rem', flexDirection: 'row',
          }}>
            <Image
              width={35}
              height={35}
